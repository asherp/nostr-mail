# nostr-mail - Legacy Docker Setup

> **Note**: This documentation is for the legacy Docker/Python setup. For the current cross-platform Tauri application, see the main [README.md](README.md).
...
The original Nostr-mail docker implementation used NIP-04, which has many [issues pointed out here](https://github.com/nostr-protocol/nips/issues/107). The new Tauri App uses NIP-44 by default, but is backward compatible with NIP-04.
