...
class DOMManager {
    ...
    initializeElements() {
        this.elements = {
            ...
            glossiaEncodingBody: this.getElement('glossia-encoding-body'),
            glossiaEncodingSignature: this.getElement('glossia-encoding-signature'),
            glossiaEncodingPubkey: this.getElement('glossia-encoding-pubkey'),
